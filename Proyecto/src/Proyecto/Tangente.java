...
public class Tangente extends JFrame{
    public Tangente(){
        ...
        JLabel Tangentes = new JLabel("Tan( ");
        Tangentes.setBounds(40, 50, 60, 50);
        Tangentes.setFont(new Font("arial", Font.PLAIN, 25));
        add(Tangentes);
        ...
        guardar.setBounds(40, 210, 150, 50);
            ...
            public void actionPerformed(ActionEvent e) {
                Historial.AgregarFavorito(resul.getText() + " - Tangente");
            }
        };
        ...
        add(cmb1);
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                float muestra = sinus(n)/cosinus(n);
                float m = Float.parseFloat(dato.getText());
                float result = sinus(m)/cosinus(m);
