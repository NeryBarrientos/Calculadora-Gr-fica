...
public class Seno extends JFrame{
    public Seno(){
        ...
        JLabel Senos = new JLabel("Sen( ");
        Senos.setBounds(40, 50, 60, 50);
        Senos.setFont(new Font("arial", Font.PLAIN, 25));
        add(Senos);
        ...
        guardar.setBounds(40, 210, 150, 50);
            ...
            public void actionPerformed(ActionEvent e) {
                Historial.AgregarFavorito(resul.getText()+ " - Seno");
            }
        };
        ...
        add(cmb1);
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                float muestra = sinus(n);
                float m = Float.parseFloat(dato.getText());
                float result = sinus(m);
